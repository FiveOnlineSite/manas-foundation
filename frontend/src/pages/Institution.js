            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="pillars-div">
                  ...
                  <p className="paragraph bridge-para pillars-para">
                    We train children in skills, such as communication, teamwork, critical thinking, and problem
              ...
              <div className="col-lg-6">
                <div className="pillars-div">
                  ...
                  <p className="paragraph bridge-para pillars-para">
                    We teach children important values such as respect, responsibility, and fairness so that
              ...
              <div className="col-lg-6">
                <div className="pillars-div">
                  ...
                  <p className="paragraph bridge-para pillars-para">
                    We promote positive mindsets in children that nurture curiosity, growth, resilience, and
