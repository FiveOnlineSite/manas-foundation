    ...
    <Layout>
                ...
                <div className="col-lg-4">
                  <div className="steps-div">
                    ...
                    <p className="paragraph bridge-para ps-4 mt-0 mb-4">
                      Click{" "}
                      <a href="https://docs.google.com/forms/d/1XF2BNvZdz1CtyREJvwXEowxq98pfeTBu4WPvY6Beb2g/viewform?edit_requested=true">
                        here
                      </a>
                       to complete the online scholarship application through
                      Google Forms
                    </p>
                  </div>
                </div>
          ...
          <div className="col-lg-12">
            <div className="row">
              ...
              <div className="col-lg-5 d-flex justify-content-lg-end justify-content-center">
                <div>
                  <img
                    src="/images/banner/students-outside.jpeg"
                    alt="document-img"
      ...
      <section className="bg-img-row">
        <div className="container">
          ...
          <p className="paragraph bridge-para">
            Providing education that’s accessible to rural and low-incomeAdd
            commentMore actions communities and opening learning opportunities
            that integrate top-tier education with holistic life skills.
          </p>
                ...
                <div className="col-lg-4">
                  <div className="single-value">
                    <div className="value-title align-items-start">
                      <img src="/images/icons/Group 8339.png" alt="value-img" />
                      <p className="ps-3 pt-2">
                        Official Sealed Transcripts from all high schools orAdd
                        commentMore actions colleges attended are required upon
                ...
                <div className="col-lg-4">
                  <div className="single-value">
                    <div className="value-title align-items-start">
                      <img src="/images/icons/Group 8339.png" alt="value-img" />
                      <p className="ps-3 pt-2">
                        Scholarship amounts are determined by a variety ofAdd
                        commentMore actions factors including, but not limited
                        to: academic success, income, and tuition cost.
                      </p>
                    </div>
                  </div>
                </div>
